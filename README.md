...
HotelRoomListConfigurator allows user to 
  ...
  - Save added room number and room type to the configuration file.
Saved configuration file is then consumed by HousekeepingRoomListAssigner app to create housekeeping report
